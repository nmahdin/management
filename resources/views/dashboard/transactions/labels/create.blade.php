<x-admin.main title="افزودن برچسب تراکنش">
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <!--   --------------- title --------------     -->
                            <h3 class="nk-block-title page-title">افزودن برچسب تراکنش</h3>
...
{{--                                <p>در مجموج {{ $n }} نفش وجود دارد.</p>--}}
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        ...
                                        <li>
                                            ...
                                            <form id="form1" action="{{ route('transactions.labels.index') }}" class="d-none"></form>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card card-preview">
                        <div class="card-inner">
                            <form action="{{ route('transactions.labels.create') }}" method="POST" class="gy-3">
                                @csrf
                                <div class="row g-3 align-center">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label class="form-label" for="name">نام برچسب</label>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('name') error @enderror" id="name" name="name" value="{{ old('name' , '') }}" placeholder="مثلاً داخلی">
                                                @error('name')
                                ...
                                <div class="row g-3 align-center">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <span class="form-note">توضیحات این برچسب</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-7 offset-lg-5">
                                        <div class="form-group mt-2">
                                            <button type="submit" class="btn btn-md btn-primary btn-dim fw-normal"  data-bs-toggle="modal" data-bs-target="#modalCreate">افزودن برچسب</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
    ...
    <x-admin.modal id="modalCreate" class="modal-body-md">در حال ایجاد برچسب جدید ...</x-admin.modal>
