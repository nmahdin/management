<x-admin.main title="افزودن دسته‌بندی مشتری">
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <!--   --------------- title --------------     -->
                            <h3 class="nk-block-title page-title">افزودن دسته‌بندی مشتری</h3>
                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card card-preview">
                        <div class="card-inner">
                            <form action="{{ route('customers.categories.create') }}" method="POST" class="gy-3">
                                @csrf
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('category_name') error @enderror" id="category_name" name="category_name" value="{{ old('category_name' , '') }}" placeholder="مثال: مشتریان ویژه، مشتریان عادی">
                                                @error('name')
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('notes') error @enderror" id="notes" name="notes" value="{{ old('notes' , '') }}" placeholder="توضیحات مربوط به این دسته‌بندی">
                                                @error('notes')
                                                <span id="fv-subject-error" class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
