                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('birthday') error @enderror" id="birthday" value="{{ $customer->birthday }}">
                                                @error('birthday')
                                                <span id="fv-full-name-error" class="invalid">{{$message}}</span>
                                                @enderror
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-control-wrap">
                                                        <ul class="custom-control-group g-3 align-center">
                                                            <li>
                                                                <div class="custom-control custom-control-lg custom-radio checked">
                                                                    <input type="radio" class="custom-control-input @error('gender') error @enderror" {{ ($customer->gender == 'female') ? 'checked' : '' }} name="gender" id="female" value="female">
                                                                    <label class="custom-control-label" for="female">خانم</label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="custom-control custom-control-lg custom-radio checked">
                                                                    <input type="radio" class="custom-control-input" id="male" {{ ($customer->gender == 'male') ? 'checked' : '' }} name="gender" value="male">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <select class="form-select js-select2" id="category_id" name="category_id">
                                                        <option value="{{  $customer->category->id }}">{{ $customer->category->category_name }}</option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <textarea class="form-control form-control-sm @error('address') error @enderror" name="address" id="address" placeholder="خیابان شریعتی، خیابان دولت، کوچه ... ، پلاک ... ، واحد ...">{{ $customer->address }}</textarea>
                                                @error('address')
                                                <span id="fv-full-name-error" class="invalid">{{$message}}</span>
                                                @enderror
                                            </div>
