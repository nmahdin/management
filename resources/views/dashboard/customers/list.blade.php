        ...
        <div class="container-xl wide-xl">
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <!--   --------------- title --------------     -->
                            <h3 class="nk-block-title page-title">مدیریت مشتریان</h3>
                            ...
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <!--   --------------- links --------------     -->
                                        <li>
                                            <a href="{{ route('customers.create') }}" class="dropdown-toggle btn btn-dark btn-dim " data-bs-toggle="modal" data-bs-target="#modalZoom"
                                            ...
                                            <form id="form12" action="{{ route('customers.create') }}" class="d-none"></form>
                                        </li>
                                        <li>
                                            <a href="{{ route('customers.trash') }}" class="dropdown-toggle btn btn-light btn-dim" data-bs-toggle="modal" data-bs-target="#modalZoom"
                                            ...
                                            <form id="form13" action="{{ route('customers.trash') }}" class="d-none"></form>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="alert alert-fill alert-success alert-icon bg-success-dim text-success">
                    ...
                    <a href="{{ route('customers.trash') }}" class="text-success" data-bs-toggle="modal" data-bs-target="#modalZoom"
                       onclick="event.preventDefault(); document.getElementById('form13').submit();">
                        <u>سطل زباله</u>
                    </a>
                    منتقل شد.
                            ...
                            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                ...
                                <tr class="nk-tb-item">
                                    ...
                                    <td class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="tb-lead"><a href="{{ route('customers.info' , ['customer' => $customer->id]) }}">{{ $customer->name }}</a> <span class="dot dot-success d-md-none ms-1">اقوام</span></span>
                                    ...
                                    <td class="nk-tb-col nk-tb-col-tools">
                                        <ul class="nk-tb-actions gx-1">
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{ route('customers.edit' , ['customer' => $customer->id]) }}" class="btn btn-trigger btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="ویرایش">
                                                    <em class="icon ni ni-edit-alt-fill"></em>
                                                </a>
                                            </li>
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{ route('customers.info' , ['customer' => $customer->id]) }}"
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{ route('customers.delete' , ['customer' => $customer->id]) }}" onclick="event.preventDefault(); document.getElementById('delete_cus{{$customer->id}}').submit();"
                                                   class="btn btn-trigger btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="حذف">
                                                    <em class="icon ni ni-trash-fill"></em>
                                                </a>
                                                <form id="delete_cus{{$customer->id}}" method="post" action="{{ route('customers.delete' , ['customer' => $customer->id]) }}" class="d-none">@csrf @method('delete')</form>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
