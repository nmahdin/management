...
<x-admin.main title="ویرایش دسته بندی فروش">
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <!--   --------------- title --------------     -->
                            <h3 class="nk-block-title page-title">ویرایش دسته بندی فروش</h3>
                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card card-preview">
                        <div class="card-inner">
                            <form action="{{ route('orders.types.edit' , $type->id) }}" method="POST" class="gy-3">
                                @csrf
                                <div class="row g-3 align-center">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label class="form-label" for="label">نام دسته بندی</label>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('label') error @enderror" id="label" name="label" value="{{ old('label' , $type->label) }}" placeholder="هنگام ثبت سفارش به این نام نمایش داده می شود">
                                                @error('label')
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('note') error @enderror" id="note" name="note" value="{{ old('not' , $type->note) }}" placeholder="اختیاری">
                                                @error('note')
                                                <span id="fv-subject-error" class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-7 offset-lg-5">
                                        <div class="form-group mt-2">
                                            <button type="submit" class="btn btn-md btn-primary btn-dim"  data-bs-toggle="modal" data-bs-target="#modalCreate">ویرایش دسته بندی</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
