...
<x-admin.main title="افزودن دسته بندی فروش">
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <!--   --------------- title --------------     -->
                            <h3 class="nk-block-title page-title">افزودن دسته بندی فروش</h3>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('label') error @enderror" id="label" name="label" value="{{ old('label' , '') }}" placeholder="هنگام ثبت سفارش به این نام نمایش داده می شود">
                                                @error('label')
