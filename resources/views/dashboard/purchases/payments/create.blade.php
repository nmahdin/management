                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">پرداخت مبلغ برای خرید</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="nk-block">
                    <div class="card card-bordered">
                        <div class="card-inner">
                            ...
                            <form action="{{ route('purchases.payments.create') }}" method="post">
                                @csrf
                                <div class="row g-4">
                                    @if(isset($purchases))
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-label" for="purchase_id">خرید مربوطه</label>
                                                <div class="form-control-wrap">
                                                    <select class="form-select js-select2" id="purchase_id"
                                                            name="purchase_id">
                                                        @foreach($purchases as $purchase)
                                                            <option value="{{ $purchase->id }}">خرید
                                                                #{{ $purchase->id }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('purchase_id')
