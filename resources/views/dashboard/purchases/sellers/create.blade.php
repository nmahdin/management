                ...
                <div class="nk-block nk-block-lg">
                    <div class="card card-preview">
                        <div class="card-inner">
                            ...
                            <form action="{{ route('purchases.sellers.create') }}" method="post">
                                @csrf
                                <div class="row g-4">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('number') error @enderror" id="number" name="number" value="{{ old('number' , '') }}">
                                                @error('number')
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="address" id="address" placeholder="آدرس فروشنده">{{ old('address' , '') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="form-label" for="notes">یادداشت</label>
                                            <textarea class="form-control form-control-sm" name="notes" id="notes" placeholder="یادداشت یا نکته یا یادآوری در مورد فروشنده">{{ old('notes' , '') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
