                                ...
                                <div class="row g-4">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('code') error @enderror" id="code" name="code" value="{{ old('code' , '') }}">
                                                @error('code')
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap number-spinner-wrap">
                                                ...
                                                <input type="text" class="form-control number-spinner" name="amount" id="amount" value="{{ old('amount' , 1) }}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('unit') error @enderror" id="unit" name="unit" value="{{ old('unit' , '') }}">
                                                @error('unit')
                                                <span id="fv-full-name-error" class="invalid">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control @error('unit_price') error @enderror" id="unit_price" name="unit_price" value="{{ old('unit_price' , '') }}">
                                                @error('unit_price')
                                                <span id="fv-full-name-error" class="invalid">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control @error('total_price') error @enderror" id="total_price" name="total_price" value="{{ old('total_price' , '') }}">
                                                @error('total_price')
                                                <span id="fv-full-name-error" class="invalid">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="notes" id="notes" placeholder="یادداشت ، نکته یا یادآوری در مورد خرید">{{ old('notes' , '') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
