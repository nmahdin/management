                            ...
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <!--   --------------- links --------------     -->
                                        <li>
                                            <a href="{{ route('products.edit' , $product->id) }}" class="dropdown-toggle btn btn-secondary " data-bs-toggle="modal" data-bs-target="#modalZoom"
                                            ...
                                            <form id="form13" action="{{ route('products.edit' , $product->id) }}" class="d-none"></form>
                                        </li>
                                        <li>
