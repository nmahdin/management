<x-admin.main title="افزودن حساب مالی">
            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <!--   --------------- title --------------     -->
                            <h3 class="nk-block-title page-title">افزودن حساب مالی</h3>
                ...
                @if(session('created'))
                    <div class="alert alert-fill alert-success alert-icon bg-success-dim text-success">
                        ...
                        حساب "{{session('created')}}" با موفقیت
                        ایجاد شد.
                    </div>
                @endif
                <!-- .nk-block-head -->
                            ...
                            <form action="{{ route('accounts.create') }}" method="POST" class="gy-3">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('label') error @enderror" id="label" name="label" value="{{ old('label' , '') }}" placeholder="به نام حساب مقصد نمایش داده می شود">
                                                @error('label')
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('number') error @enderror" id="number" name="number" value="{{ old('number' , '') }}" placeholder="فقط برای ره گیری حساب قابل استفاده است">
                                                @error('number')
                                                <span id="fv-subject-error" class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('payment_label') error @enderror" id="payment_label" name="payment_label" value="{{ old('payment_label' , '') }}" placeholder="به عنوان روش پرداخت و حساب مقصد در سفارشات نمایش داده می شود">
                                                @error('payment_label')
                                                <span id="fv-subject-error" class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-7 offset-lg-5">
                                        <div class="form-group mt-2">
                                            <button type="submit" class="btn btn-md btn-primary btn-dim"  data-bs-toggle="modal" data-bs-target="#modalCreate">افزودن حساب</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
    ...
    <x-admin.modal id="modalCreate" class="modal-body-md">در حال ایجاد حساب مالی جدید ...</x-admin.modal>
