                        ...
                        <div class="card-inner">
                            <form action="{{ route('accounts.create') }}" method="POST" class="gy-3">
                                ...
                                <div class="row g-3 align-center">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label class="form-label" for="payment_ways">روش های پرداخت</label>
                                            <span class="form-note"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                            <ul class="custom-control-group g-3 align-center">
                                                ...
                                                <li>
                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                        <input type="checkbox" value="online" class="custom-control-input"
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-7 offset-lg-5">
                                        <div class="form-group mt-2">
                                            <button type="submit" class="btn btn-dim btn-outline-primary fw-normal"  data-bs-toggle="modal" data-bs-target="#modalCreate">افزودن حساب</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
