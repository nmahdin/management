                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card card-preview">
                        <div class="card-inner">
                            <form action="{{ route('orders.statuses.create') }}" method="POST" class="gy-3">
                                @csrf
                                <div class="row g-3 align-center">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label class="form-label" for="label">نام وضعیت</label>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('label') error @enderror" id="label" name="label" value="{{ old('label' , '') }}" placeholder="در سفارش ها نمایش داده می شود">
                                                @error('label')
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-7 offset-lg-5">
                                        <div class="form-group mt-2">
                                            <button type="submit" class="btn btn-md btn-primary btn-dim"  data-bs-toggle="modal" data-bs-target="#modalCreate">افزودن وضعیت</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
