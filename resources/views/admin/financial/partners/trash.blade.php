<x-admin.main title="شریک های حذف شده">
        ...
        <div class="container-xl wide-xl">
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <!--   --------------- title --------------     -->
                            <h3 class="nk-block-title page-title">شریک های حذف شده</h3>
                            <div class="nk-block-des text-soft">
                                <!--   --------------- توضیح صفحه --------------     -->
                                @if($n !== 0)
                                <p>در مجموج {{ $n }} شریک حذف وجود دارد.</p>
                                @endif
                            </div>
                        </div>
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        ...
                                        <li>
                                            ...
                                            <form id="form133" action="{{ route('partners.list') }}"
                                                  class="d-none"></form>
                                        </li>
                                    </ul>
                                </div>
                ...
                @if(session('restored'))
                    <div class="alert alert-fill alert-success alert-icon bg-success-dim text-success">
                        <em class="icon ni ni-check-circle"></em>
                        شریک "{{session('restored')}}" با موفقیت
                        بازگردانی شد.
                    </div>
                @endif
            <!-- .nk-block-head -->
                @if($n == 0)
                    ...
                    هیچ شریکی در سطل زباله وجود ندارد!
                    </div>
                @endif
