<x-admin.main title="داشبورد اصلی">
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <!--   --------------- title --------------     -->
                            <h3 class="nk-block-title page-title">داشبورد اصلی</h3>
                            <div class="nk-block-des text-soft">
                                <!--   --------------- توضیح صفحه --------------     -->
                                <p>به داشبورد اصلی خوش آمدید.</p>
                            </div>
                        </div>
                                    ...
                                    <ul class="nk-block-tools g-3">
                                        ...
                                        <li>
                                            <a href="#" class="dropdown-toggle btn btn-white btn-dim btn-outline-light" data-bs-toggle="dropdown">
                                                <em class="icon ni ni-plus"></em><span><span class="d-md-none">افزودن</span><span class="d-none d-md-block">افزودن کمپین</span></span>
                                            </a>
                                        </li>
                                ...
                                <div class="card-inner py-0 mt-n2">
                                    <div class="nk-tb-list nk-tb-flush nk-tb-dashed">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col text-end"><span>محدوده تاریخ</span></div>
                                        </div>
                                        <!-- .nk-tb-head -->
                                        <div class="nk-tb-item">
                                            <div class="nk-tb-col">
                                                <span class="tb-lead">کریسمس مبارک <span class="dot dot-success d-sm-none ms-1"></span></span>
                                            ...
                                            <div class="nk-tb-col text-end"><span>21 آبان - 30 آبان</span></div>
                                        </div>
                                        <!-- .nk-tb-item -->
                                        <div class="nk-tb-item">
                                            <div class="nk-tb-col">
                                                <span class="tb-lead">جمعه سیاه <span class="dot dot-success d-sm-none ms-1"></span></span>
                                                <span class="tb-sub">ایجاد شده در 21 آبان 1402</span>
                                            </div>
                                            <div class="nk-tb-col tb-col-mb">
                                                <ul class="d-flex gx-1">
                                        ...
                                        <div class="nk-tb-item">
                                            <div class="nk-tb-col">
                                                <span class="tb-lead">درختکاری <span class="dot dot-warning d-sm-none ms-1"></span></span>
                                        ...
                                        <div class="nk-tb-item">
                                            <div class="nk-tb-col">
                                                <span class="tb-lead">پیش نمایش فیلم فرار <span class="dot dot-success d-sm-none ms-1"></span></span>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li>
                                                            <a href="#" class="active"><span>15 روز</span></a>
                                                        </li>
                                                        <li>
                                        ...
                                        <li class="border-bottom border-0 border-dashed">
                                            ...
                                            <div class="align-center">
                                                ...
                                                <div class="dropdown ms-3">
                                                    <a class="dropdown-toggle dropdown-indicator sub-text" href="#" type="button" data-bs-toggle="dropdown" data-bs-offset="0, 10">دی 21 - فروردین 21</a>
                                                    <div class="dropdown-menu dropdown-menu-end text-right">
                                                        <ul class="link-list-opt">
                                                            <li>
                                                                <a href="#"><span>فروردین 21 - تیر 21</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="#"><span>تیر 21 - مهر 21</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="#"><span>مهر 21 - دی 21</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="#"><span>دی 21 - فروردین 21</span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-title-group">
                                        ...
                                        <div class="card-tools">
                                            <ul class="d-flex gx-2">
                                                <li>
                                                    <button class="btn btn-icon btn-sm btn-outline-light rounded-pill"><em class="icon ni ni-chevron-left"></em></button>
                                                </li>
                                                <li>
                                                    <button class="btn btn-icon btn-sm btn-outline-primary rounded-pill"><em class="icon ni ni-chevron-right"></em></button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="rounded px-2 py-4 bg-primary">
                                        <div class="d-flex">
                                            <div class="w-50 px-4">
                                                ...
                                                <div class="fs-14px text-white text-opacity-75">فالوور جدید</div>
                                            </div>
                                            <div class="border-start opacity-50"></div>
                                            <div class="w-50 px-4">
                                                <span class="fs-2 lh-1 mb-1 text-white">120هزار</span>
                                                <div class="fs-14px text-white text-opacity-75">هدف فالوور</div>
                                            </div>
                                        </div>
                                    </div>
