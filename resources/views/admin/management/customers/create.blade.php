                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control @error('number') error @enderror" id="number" name="number">
                                                @error('number')
                                                <span id="fv-full-name-error" class="invalid">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" value="تهران" class="form-control @error('city') error @enderror" id="city" name="city">
                                                @error('city')
                                                <span id="fv-full-name-error" class="invalid">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <textarea class="form-control form-control-sm @error('address') error @enderror" name="address" id="address" placeholder="خیابان شریعتی، خیابان دولت، کوچه ... ، پلاک ... ، واحد ..."></textarea>
                                                @error('address')
                                                <span id="fv-full-name-error" class="invalid">{{$message}}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <ul class="custom-control-group g-3 align-center">
                                                <li>
                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                        <input type="checkbox" value="phone" class="custom-control-input @error('com_ways') error @enderror" id="phone" name="com_ways[]">
                                                ...
                                                <li>
                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                        <input type="checkbox" value="eitaa" class="custom-control-input" id="eitaa" name="com_ways[]">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="notes" id="notes" placeholder="یادداشت یا نکته یا یادآوری در مورد مشتری"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
