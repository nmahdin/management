                                        ...
                                        <tr class="tb-odr-item">
                                            ...
                                            <td class="tb-odr-action">
                                                <div class="tb-odr-btns d-none d-md-inline" style=" margin-right: 3px">
                                                    <a href="{{ route('products.status.trash.r' , ['status' => $status->id]) }}"
                                                    ...
                                                    <form id="restore_sta{{$status->id}}" method="post"
                                                          action="{{ route('products.status.trash.r' , ['status' => $status->id]) }}"
                                                          class="d-none">@csrf @method('post')</form>

                                                </div>

                                                <div class="tb-odr-btns d-none d-md-inline" style=" margin-right: 3px">
                                                    <a href="{{ route('products.status.trash.d' , ['status' => $status->id]) }}"
                                                    ...
                                                    <form id="delete_sta{{$status->id}}" method="post"
                                                          action="{{ route('products.status.trash.d' , ['status' => $status->id]) }}"
