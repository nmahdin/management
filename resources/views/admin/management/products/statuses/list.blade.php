<x-admin.main title="لیست وضعیت ها">
            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <!--   --------------- title --------------     -->
                            <h3 class="nk-block-title page-title">لیست وضعیت ها</h3>
                            <div class="nk-block-des text-soft">
                                <!--   --------------- توضیح صفحه --------------     -->
                                @if($n !== 0)
                                <p>در مجموج {{ $n }} وضعیت وجود دارد.</p>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <!--   --------------- links --------------     -->
                                        <li>
                                            <a href="{{ route('products.status.create') }}"
                                            ...
                                            <form id="form133" action="{{ route('products.status.create') }}"
                                                  class="d-none"></form>
                                        </li>
                                        <li>
                                            <a href="{{ route('products.statuses.trash') }}"
                                               class="dropdown-toggle btn btn-light btn-dim" data-bs-toggle="modal"
                                               data-bs-target="#modalZoom"
                                               onclick="event.preventDefault(); document.getElementById('sta_trash').submit();">
                                                <em class="icon ni ni-trash"></em>
                                                <span class="fw-normal">
                                                    سطل زباله
                                                </span>
                                            </a>
                                            <form id="sta_trash" action="{{ route('products.statuses.trash') }}"
                                                  class="d-none"></form>
                                        </li>
                                    </ul>
                                </div>
                ...
                @if(session('deleted'))
                    <div class="alert alert-fill alert-success alert-icon bg-success-dim text-success">
                        ...
                        <a href="{{ route('products.statuses.trash') }}" class="text-success" data-bs-toggle="modal"
                           data-bs-target="#modalZoom"
                           onclick="event.preventDefault(); document.getElementById('sta_trash').submit();">
                            <u>سطل زباله</u>
                        </a>
                ...
                @if(session('edited'))
                    <div class="alert alert-fill alert-success alert-icon bg-success-dim text-success">
                        <em class="icon ni ni-check-circle"></em>
                        وضعیت "{{session('edited')}}" با موفقیت
                        ویرایش شد.
                    </div>
                @endif
            <!-- .nk-block-head -->
                @if($n == 0)
                    ...
                    هیچ وضعیتی وجود ندارد! سطل زباله را بررسی کنید.
                    </div>
                @endif
                                        ...
                                        <tr class="tb-odr-item">
                                            ...
                                            <td class="tb-odr-action">
                                                <div class="tb-odr-btns d-none d-md-inline">
                                                    <a href="{{ route('products.status.edit' , ['status' => $status->id]) }}" class="btn btn-warning btn-dim"><em
                                                ...
                                                <div class="tb-odr-btns d-none d-md-inline" style=" margin-right: 3px">
                                                    <a href="{{ route('products.status.delete' , ['status' => $status->id]) }}"
